...
4. 🎉 Created a new repository [Tomrm96/Medium-Clone](https://github.com/Tomrm96/Medium-Clone)
5. 📝 Committed to a private repo
6. ➕ Created a new branch `main` in a private repo
7. 🎉 Created a new private repository
8. ➕ Created a new branch [`master`](https://github.com/Tomrm96/laravel-crud-code-along/tree/master) in [Tomrm96/laravel-crud-code-along](https://github.com/Tomrm96/laravel-crud-code-along)
9. 🎉 Created a new private repository
10. 🎉 Created a new repository [Tomrm96/laravel-crud-code-along](https://github.com/Tomrm96/laravel-crud-code-along)
